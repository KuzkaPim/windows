...
const forms = () => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('assets/server.php', formData).then(res => console.log(res)).then(() => statusMessage.textContent = message.success).catch(() => statusMessage.textContent = message.failure).finally(() => {
        clearInputs();
        setTimeout(() => {
